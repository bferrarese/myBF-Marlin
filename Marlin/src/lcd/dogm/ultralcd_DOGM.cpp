...
bool MarlinUI::detected() { return true; }
  ...
  void MarlinUI::draw_marlin_bootscreen(const bool line2/*=false*/) {
    ...
    constexpr u8g_uint_t text_width_1 = u8g_uint_t((sizeof(SHORT_myBUILD_VERSION) - 1) * (MENU_FONT_WIDTH)),
    ...
    auto _draw_bootscreen_bmp = [&](const uint8_t *bitmap) {
      ...
      set_font(FONT_MENU);
      if (!two_part || !line2) lcd_put_u8str_P(txt_offx_1, txt_base - (MENU_FONT_HEIGHT), PSTR(SHORT_myBUILD_VERSION));
